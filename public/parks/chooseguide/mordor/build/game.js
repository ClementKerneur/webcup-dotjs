...
(function() {
  this.pageZeroState = {
    create: function() {
      this.mordorSound = this.game.add.audio("mordorSound", 1);
      this.mordorSound.play();
      this.starworld = this.game.add.image(0, 0, 'starworld');
      this.disk = this.game.add.image(0, 0, 'disk');
      this.keyArray = ['cp', 'vader', 'yoda'];
      this.currentKey = 0;
...
(function() {
  this.runMordor = function() {
    this.game = new Phaser.Game(1280, 720, Phaser.CANVAS, 'mordor-cyg', null, false);
    this.game.e = {};
    ...
    this.game.state.add('boot', {
      preload: function() {
        ...
        this.game.load.image("cp", "/static/parks/chooseguide/mordor/assets/cp.png");
        this.game.load.image("disk", "/static/parks/chooseguide/mordor/assets/disk.png");
        this.game.load.image("starworld", "/static/parks/chooseguide/mordor/assets/starworld.png");
        this.game.load.image("vader", "/static/parks/chooseguide/mordor/assets/vader.png");
        this.game.load.image("yoda", "/static/parks/chooseguide/mordor/assets/yoda.png");
        this.game.load.spritesheet("next", "/static/parks/chooseguide/mordor/assets/next_button.png", 214, 213, 2);
        this.game.load.spritesheet("previous", "/static/parks/chooseguide/mordor/assets/previous_button.png", 214, 213, 2);
        this.game.load.spritesheet("select", "/static/parks/chooseguide/mordor/assets/select_button.png", 150, 45, 2);
        this.game.load.image("choose", "/static/parks/chooseguide/mordor/assets/choose.png");
        this.game.load.image("cp_price", "/static/parks/chooseguide/mordor/assets/cp_price.png");
        this.game.load.image("vader_price", "/static/parks/chooseguide/mordor/assets/vader_price.png");
        this.game.load.image("yoda_price", "/static/parks/chooseguide/mordor/assets/yoda_price.png");
        this.game.load.audio("selectSound", "/static/parks/chooseguide/mordor/assets/Swoosh.mp3");
        return this.game.load.audio("mordorSound", "/static/parks/chooseguide/mordor/assets/mordor.mp3");
      },
      create: function() {
