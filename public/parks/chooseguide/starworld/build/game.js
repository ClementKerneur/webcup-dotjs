...
(function() {
  this.runStarWorld = function() {
    this.game = new Phaser.Game(1280, 720, Phaser.CANVAS, 'starworld-cyg', null, false);
    this.game.e = {};
    ...
    this.game.state.add('boot', {
      preload: function() {
        ...
        this.game.load.image("cp", "/static/parks/chooseguide/starworld/assets/cp.png");
        this.game.load.image("disk", "/static/parks/chooseguide/starworld/assets/disk.png");
        this.game.load.image("starship", "/static/parks/chooseguide/starworld/assets/starship.png");
        this.game.load.image("starworld", "/static/parks/chooseguide/starworld/assets/starworld.jpg");
        this.game.load.image("vader", "/static/parks/chooseguide/starworld/assets/vader.png");
        this.game.load.image("yoda", "/static/parks/chooseguide/starworld/assets/yoda.png");
        this.game.load.spritesheet("next", "/static/parks/chooseguide/starworld/assets/next_button.png", 214, 213, 2);
        this.game.load.spritesheet("previous", "/static/parks/chooseguide/starworld/assets/previous_button.png", 214, 213, 2);
        this.game.load.spritesheet("select", "/static/parks/chooseguide/starworld/assets/select_button.png", 150, 45, 2);
        this.game.load.image("choose", "/static/parks/chooseguide/starworld/assets/choose.png");
        this.game.load.image("cp_price", "/static/parks/chooseguide/starworld/assets/cp_price.png");
        this.game.load.image("vader_price", "/static/parks/chooseguide/starworld/assets/vader_price.png");
        this.game.load.image("yoda_price", "/static/parks/chooseguide/starworld/assets/yoda_price.png");
        this.game.load.audio("selectSound", "/static/parks/chooseguide/starworld/assets/Swoosh.mp3");
        return this.game.load.audio("starSound", "/static/parks/chooseguide/starworld/assets/starSound.mp3");
      },
      create: function() {
